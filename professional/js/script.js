...
const questions = [
  ...
  },
  {
    ...
    answers: [
      { text: 'I avoid or don’t respond to my partner.', value: -2 },
      { text: 'I tell my partner that I need some time alone and why.', value: 2 },
      { text: 'I keep spending time with my partner.', value: -1},
  ...
  //Freedom
  {
    ...
    answers: [
      { text: 'Try to understand or see if there’s a resolution.', value: 2 },
      { text: 'Threaten them, hurt them/myself, or damage their property.', value: -2 },
      { text: 'Keep trying to gain access to them.', value: -1},
      { text: 'Both B & C', value: -4}
    ]
  },
  {
    block: "Freedom",
  ...
  //Conflict Resolution
  {
    ...
    answers: [
      ...
      { text: 'I let my partner decide, but I am not happy with the decision.', value: -1 },
      { text: 'I’m okay with going where my partner wants this time and saving my option for another time.', value: 1},
      { text: 'I cancel date night.', value: -3}
    ]
  },
  {
    block: "Conflict Resolution",
  ...
  },
  {
    ...
    answers: [
      { text: 'I acknowledge the impact of my actions, apologize, and try to never hurt them again.', value: 2 },
      { text: 'I say that I understand, but that I had good intentions.', value: 1 },
      { text: 'I tell them that they’re being sensitive.', value: -2},
      { text: 'I quickly apologize to move away from the conflict.', value: -1}
    ]
  },
  //Compatibility
  {
  ...
  },
  {
    ...
    answers: [
      ...
      { text: 'I don’t tell them because I’m scared they will hurt me.', value: -1}
    ]
  },
  {
    block: "Honesty",
  ...
  {
    block: "Safety",
    question: "My partner can be their most authentic self when they are with me.",
    answers: [
      { text: 'Strongly Agree', value: 2 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -1},
  ...
  },
  {
    ...
    question: "I have...",
    answers: [
      { text: 'Hit my partner once.', value: -3 },
      { text: 'Hit my partner multiple times.', value: -4 },
      { text: 'Never hit my partner.', value: 2},
      { text: 'Almost hit my partner.', value: -1}
    ]
  },
  {
    block: "Safety",
