...
const questions = [
  ...
  {
    block: "Boundaries",
    question: "It is okay for me to look through my loved one’s private belongings with or without them knowing.",
    answers: [
  ...
  {
    block: "Boundaries",
    question: "I am comfortable telling my loved one that I don’t like something or that I don’t like being spoken to in a certain way.",
    answers: [
      { text: 'Strongly Agree', value: 3 },
      { text: 'Somewhat Agree', value: 2 },
  ...
  {
    block: "Boundaries",
    question: "I understand that my loved one has physical boundaries and may not want to be touched.",
    answers: [
  ...
  },
  {
    ...
    answers: [
      { text: 'I avoid or don’t respond to my loved one.', value: -3 },
      { text: 'I tell my loved one that I need some time alone and why.', value: 2 },
      { text: 'I keep spending time with my loved one.', value: -2},
      { text: 'I lie to my loved one and say that I’m busy.', value: -2}
    ]
  },
  {
    block: "Boundaries",
    question: "I put my loved one’s wants and needs above my own in order to keep my loved one happy.",
    answers: [
      { text: 'Strongly Agree', value: -2 },
      { text: 'Somewhat Agree', value: -1 },
      { text: 'Somewhat Disagree', value: 1},
  ...
  {
    block: "Communication",
    question: "When I am upset with my loved one, I raise my voice or call them names.",
    answers: [
      { text: 'Strongly Agree', value: -3 },
      { text: 'Somewhat Agree', value: -2 },
      { text: 'Somewhat Disagree', value: 0},
  ...
  {
    block: "Communication",
    question: "When I disagree with my loved one, I criticize their perspective. ",
    answers: [
      { text: 'Strongly Agree', value: -2 },
      { text: 'Somewhat Agree', value: -1 },
      { text: 'Somewhat Disagree', value: 1},
  ...
  {
    block: "Communication",
    question: "I can have an open and honest conversation with my loved one when we are in disagreement.",
    answers: [
      { text: 'Strongly Agree', value: 2 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -1},
  ...
  {
    block: "Communication",
    question: "When my loved one does something that upsets me, I don’t say anything because I would rather not get into an argument.",
    answers: [
      { text: 'Strongly Agree', value: -2 },
      { text: 'Somewhat Agree', value: -1 },
      { text: 'Somewhat Disagree', value: 1},
  ...
  {
    block: "Communication",
    question: "I interrupt my loved one or try to finish their sentences for them.",
    answers: [
      { text: 'Strongly Agree', value: -2 },
      { text: 'Somewhat Agree', value: -1 },
      { text: 'Somewhat Disagree', value: 0},
  ...
  {
    block: "Trust",
    question: "If my loved one shares something private with me, I make sure to keep it between us unless I have permission to share.",
    answers: [
      { text: 'Strongly Agree', value: 3 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -2},
  ...
  {
    block: "Trust",
    question: "Sometimes I am scared of telling my loved one things because I don’t want to be judged by them.",
    answers: [
      { text: 'Strongly Agree', value: -2 },
      { text: 'Somewhat Agree', value: -1 },
      { text: 'Somewhat Disagree', value: 1},
  ...
  {
    block: "Trust",
    question: "I am respectful to my loved one when they’re not around.",
    answers: [
      { text: 'Strongly Agree', value: 3 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -2},
  ...
  {
    block: "Freedom",
    question: "If I want to end my relationship with a loved one I would...",
    answers: [
      { text: 'Block their number/social media.', value: -2 },
      { text: 'Have an open conversation with them.', value: 2 },
      { text: 'Have a mutual friend/family member tell them.', value: -1},
      { text: 'Not say anything to avoid hurting their feelings. ', value: -2}
    ]
  },
  {
    block: "Freedom",
    question: "My loved one needs to ask me permission in order to see their friends and family, or go somewhere.",
    answers: [
      { text: 'Strongly Agree', value: -3 },
      { text: 'Somewhat Agree', value: -2 },
      { text: 'Somewhat Disagree', value: 0},
  ...
  {
    block: "Freedom",
    question: "I support my loved one to explore their interests even if they differ from mine.",
    answers: [
      { text: 'Strongly Agree', value: 2 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -1},
  ...
  {
    block: "Freedom",
    question: "My loved one can spend their money as they wish.",
    answers: [
      { text: 'Strongly Agree', value: 2 },
  ...
  {
    block: "Freedom",
    question: "I keep track of who my loved one communicates with.",
    answers: [
      { text: 'Strongly Agree', value: -2 },
      { text: 'Somewhat Agree', value: -1 },
      { text: 'Somewhat Disagree', value: 0},
  ...
  //Conflict Resolution
  {
    ...
    question: "My loved one and I are arguing about which movie to watch. How do you resolve this issue?",
    answers: [
      { text: 'I argue until I win.', value: -2 },
      { text: 'I let my loved one decide, but I am not happy with the decision', value: -2 },
      { text: 'I’m okay with watching what my loved one wants this time and saving my option for another time.', value: 1},
      { text: 'I cancel the movie plans.', value: -2}
    ]
  },
  {
    block: "Conflict Resolution",
    question: "When my loved one and I disagree about something, I am more likely to yell at them rather than have a calm discussion.",
    answers: [
      { text: 'Strongly Agree', value: -2 },
      { text: 'Somewhat Agree', value: -1 },
      { text: 'Somewhat Disagree', value: 0},
  ...
  {
    block: "Conflict Resolution",
    question: "I try to understand my loved one’s perspective without getting defensive.",
    answers: [
      { text: 'Strongly Agree', value: 2 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -1},
  ...
  {
    block: "Conflict Resolution",
    question: "After a conflict, I check in with my loved one to see how they’re feeling.",
    answers: [
      { text: 'Strongly Agree', value: 2 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -1},
  ...
  {
    block: "Conflict Resolution",
    question: "When my loved one says that I hurt them,...",
    answers: [
  ...
  {
    block: "Compatibility",
    question: "I enjoy spending time with my loved one.",
    answers: [
      { text: 'Strongly Agree', value: 2 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -2},
  ...
  {
    block: "Compatibility",
    question: "I support my loved one’s relationships with their friends and family.",
    answers: [
      { text: 'Strongly Agree', value: 2 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -1},
  ...
  {
    block: "Compatibility",
    question: "I respect my loved one’s core values, even if I don't agree with them.",
    answers: [
      { text: 'Strongly Agree', value: 2 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -1},
  ...
  {
    block: "Compatibility",
    question: "I enjoy learning about my loved one and their passions.",
    answers: [
      { text: 'Strongly Agree', value: 2 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -1},
  ...
  {
    block: "Compatibility",
    question: "I help my loved one grow and am a positive influence on their behavior.",
    answers: [
      { text: 'Strongly Agree', value: 3 },
      { text: 'Somewhat Agree', value: 2 },
      { text: 'Somewhat Disagree', value: -2},
  ...
  {
    block: "Respect",
    question: "I appreciate my loved one’s efforts and I constantly show them my appreciation.",
    answers: [
      { text: 'Strongly Agree', value: 2 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -1},
  ...
  {
    block: "Respect",
    question: "I understand my own value and will not let my loved one treat me or speak to me in a way that is demeaning.",
    answers: [
      { text: 'Strongly Agree', value: 3 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -2},
  ...
  {
    block: "Respect",
    question: "I view my loved one as my equal.",
    answers: [
      { text: 'Strongly Agree', value: 2 },
      { text: 'Somewhat Agree', value: 0 },
      { text: 'Somewhat Disagree', value: -1},
  ...
  {
    block: "Respect",
    question: "I understand when my loved one is busy and I try to lighten their load.",
    answers: [
      { text: 'Strongly Agree', value: 2 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -1},
  ...
  {
    block: "Respect",
    question: "I neglect my loved one when I’m around other people.",
    answers: [
      { text: 'Strongly Agree', value: -3 },
      { text: 'Somewhat Agree', value: -2 },
      { text: 'Somewhat Disagree', value: 0},
  ...
  {
    block: "Honesty",
    question: "I clearly express my intentions and feelings to my loved one.",
    answers: [
      { text: 'Strongly Agree', value: 3 },
      { text: 'Somewhat Agree', value: 2 },
      { text: 'Somewhat Disagree', value: -1},
  ...
  {
    block: "Honesty",
    question: "I encourage my loved one to be honest about their feelings rather than sugarcoat them in order to protect my feelings.",
    answers: [
      { text: 'Strongly Agree', value: 2 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -1},
  ...
  {
    block: "Honesty",
    question: "I lie/have lied to my loved one.",
    answers: [
      { text: 'Strongly Agree', value: -2 },
      { text: 'Somewhat Agree', value: -1 },
      { text: 'Somewhat Disagree', value: 1},
  ...
  {
    block: "Honesty",
    question: "If your loved one is busy and says that they can’t spend as much time with you anymore, what do you do?",
    answers: [
      { text: 'I get upset because if they wanted to spend time with me, they would.', value: -2 },
      { text: 'I understand and ask if I can help in any way.', value: 2 },
      { text: 'I try to find out why they’re busy because I don’t trust them.', value: -2},
      { text: 'I start spending time with other people to make them jealous.', value: -2}
    ]
  },
  {
    block: "Honesty",
    question: "I make excuses when I say/do things that make my loved one upset/uncomfortable.",
    answers: [
      { text: 'Strongly Agree', value: -3 },
      { text: 'Somewhat Agree', value: -2 },
      { text: 'Somewhat Disagree', value: 1},
  ...
  {
    block: "Safety",
    question: "I let my loved one know that I like/love them.",
    answers: [
      { text: 'Strongly Agree', value: 2 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -1},
  ...
  {
    block: "Safety",
    question: "My loved one can be their most authentic self when they are with me.",
    answers: [
      { text: 'Strongly Agree', value: 3 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -1},
  ...
  },
  {
    ...
    question: "I have...",
    answers: [
      { text: 'Hit my loved one once.', value: -4 },
      { text: 'Hit my loved one multiple times.', value: -4 },
      { text: 'Never hit my loved one.', value: 3},
      { text: 'Almost hit my loved one.', value: -2}
    ]
  },
  {
    block: "Safety",
    question: "I always want the best for my loved one.",
    answers: [
      { text: 'Strongly Agree', value: 3 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -2},
  ...
  {
    block: "Safety",
    question: "I criticize my loved one’s appearance or try to change how they look.",
    answers: [
      { text: 'Strongly Agree', value: -3 },
      { text: 'Somewhat Agree', value: -2 },
      { text: 'Somewhat Disagree', value: 1},
  ...
  {
    block: "Understanding",
    question: "I share my feelings with my loved one and encourage my loved one to do the same.",
    answers: [
      { text: 'Strongly Agree', value: 2 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -1},
  ...
  {
    block: "Understanding",
    question: "I am there for my loved one when they feel sad, anxious, confused, etc.",
    answers: [
      { text: 'Strongly Agree', value: 2 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -1},
  ...
  {
    block: "Understanding",
    question: "I ask my loved one what they want or need instead of assuming.",
    answers: [
      { text: 'Strongly Agree', value: 3 },
      { text: 'Somewhat Agree', value: 2 },
      { text: 'Somewhat Disagree', value: -1},
  ...
  {
    block: "Understanding",
    question: "I try to put myself in my loved one’s shoes to better understand what they are feeling.",
    answers: [
      { text: 'Strongly Agree', value: 3 },
      { text: 'Somewhat Agree', value: 2 },
      { text: 'Somewhat Disagree', value: -2},
  ...
  {
    block: "Understanding",
    question: "I don’t make conclusions about my loved one until I completely understand them and their feelings.",
    answers: [
      { text: 'Strongly Agree', value: 2 },
      { text: 'Somewhat Agree', value: 1 },
      { text: 'Somewhat Disagree', value: -1},
